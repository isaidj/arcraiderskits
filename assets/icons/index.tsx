export const SvgGridBig = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 28 28" fill="currentColor" {...props}>
    <title>{"grid"}</title>
    <path
      fillRule="evenodd"
...
export const SvgGridSmall = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 -0.5 21 21" fill="currentColor" {...props}>
    <title>{"grid"}</title>
    <path
      fillRule="evenodd"
