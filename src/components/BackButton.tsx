...
export default function BackButton({ label }: BackButtonProps) {
  ...
  return (
    <button
      onClick={handleBack}
      className="inline-flex items-center gap-2 cursor-pointer px-4 py-2 bg-[#110918] border border-[#646081] rounded-lg text-gray-300 hover:text-white hover:shadow-[0_0_20px_rgba(100,96,129,0.6)] transition-all group"
    >
