      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-semibold border transition-all ${
            selectedTrader === "All" ? "bg-[#00ffff]/20 border-[#00ffff] text-[#00ffff]" : "bg-[#0d111d]/50 backdrop-blur-sm border-gray-700 text-gray-400 hover:border-gray-500"
          }`}
        >
        ...
        {traders.map((trader) => {
          ...
          return (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-semibold border transition-all ${
                isSelected ? badgeColor : "bg-[#0d111d]/50 backdrop-blur-sm border-gray-700 text-gray-400 hover:border-gray-500"
              }`}
            >
              {trader} ({count})
            </button>
