    ...
    <div>
      ...
      <div className="mb-8 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <div className="flex rounded-lg overflow-hidden border border-gray-700 h-10">
              <button
                ...
                className={`px-2 py-2 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#00ffff] ${
        ...
        <p className="text-sm text-gray-400">
          ...
          {isPending && (
            <span role="status" className="ml-2 text-[#00ffff]">
