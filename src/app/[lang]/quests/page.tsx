...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }): Promise<Metadata> {
  ...
  const descriptions: Record<Locale, string> = {
    en: "Browse all Arc Raiders quests and missions with detailed guides and video walkthroughs. Complete objectives, earn rewards, and progress through quest chains.",
    es: "Explora todas las misiones de Arc Raiders con guías detalladas y videos tutoriales. Completa objetivos, gana recompensas y progresa en cadenas de misiones.",
    de: "Durchsuchen Sie alle Arc Raiders Quests und Missionen mit detaillierten Anleitungen und Video-Walkthroughs. Erfüllen Sie Ziele, verdienen Sie Belohnungen und schreiten Sie durch Questketten voran.",
    fr: "Parcourez toutes les quêtes et missions d'Arc Raiders avec des guides détaillés et des vidéos explicatives. Accomplissez des objectifs, gagnez des récompenses et progressez dans les chaînes de quêtes.",
    pt: "Navegue por todas as missões do Arc Raiders com guias detalhados e vídeos tutoriais. Complete objetivos, ganhe recompensas e progrida através de cadeias de missões.",
    pl: "Przeglądaj wszystkie zadania i misje Arc Raiders ze szczegółowymi przewodnikami i filmami instruktażowymi. Wykonuj cele, zdobywaj nagrody i rozwijaj się przez łańcuchy zadań.",
    no: "Bla gjennom alle Arc Raiders oppdrag og misjoner med detaljerte guider og videoveiledninger. Fullfør mål, tjen belønninger og gå videre gjennom oppdragskjeder.",
    da: "Gennemse alle Arc Raiders quest og missioner med detaljerede guider og videogennemgange. Fuldfør mål, optjen belønninger og avancer gennem questkæder.",
    it: "Sfoglia tutte le missioni e quest di Arc Raiders con guide dettagliate e video tutorial. Completa obiettivi, guadagna ricompense e progredisci attraverso catene di quest.",
    uk: "Переглядайте всі квести та місії Arc Raiders з детальними гідами та відео-інструкціями. Виконуйте завдання, отримуйте винагороди та просувайтесь ланцюгами квестів.",
    kr: "자세한 가이드와 비디오 튜토리얼로 모든 Arc Raiders 퀘스트와 임무를 찾아보세요. 목표를 완료하고 보상을 받으며 퀘스트 체인을 진행하세요.",
    ru: "Просматривайте все квесты и миссии Arc Raiders с подробными гайдами и видео-прохождениями. Выполняйте задачи, зарабатывайте награды и продвигайтесь по цепочкам квестов.",
    "zh-CN": "浏览所有Arc Raiders任务和使命，包含详细指南和视频教程。完成目标，获得奖励，并在任务链中进步。",
    ja: "詳細なガイドとビデオウォークスルーでArc Raidersのすべてのクエストとミッションを閲覧できます。目標を達成し、報酬を獲得し、クエストチェーンを進めます。",
    tr: "Detaylı kılavuzlar ve video rehberlerle tüm Arc Raiders görevlerini ve misyonlarını göz atın. Hedefleri tamamlayın, ödüller kazanın ve görev zincirlerinde ilerleyin.",
    "zh-TW": "瀏覽所有Arc Raiders任務和使命，包含詳細指南和影片教學。完成目標，獲得獎勵，並在任務鏈中進步。",
    sr: "Прегледајте све Arc Raiders задатке и мисије са детаљним водичима и видео упутствима. Испуните циљеве, зарадите награде и напредујте кроз ланце задатака.",
    hr: "Pregledajte sve Arc Raiders zadatke i misije s detaljnim vodičima i video uputama. Ispunite ciljeve, zaradite nagrade i napredujte kroz lance zadataka.",
  };
