...
export default function QuestsLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Purple/Amber Glow Effect (mix de los colores de traders) */}
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-purple-600/10 rounded-full blur-[120px]" style={{ zIndex: -15 }} />
